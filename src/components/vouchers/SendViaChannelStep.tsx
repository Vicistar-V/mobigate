...
const CHANNEL_CONFIG: Record<ChannelType, { label: string; icon: typeof Mail; color: string; bgColor: string; placeholder: string; inputMode: "email" | "tel" | "text"; recipientLabel: string; buttonColor: string }> = {
  ...
  mobiChat: { label: "Send via Mobi-Chat", icon: MessageCircle, color: "text-primary", bgColor: "bg-primary/10", placeholder: "Search Mobiface user...", inputMode: "text", recipientLabel: "Mobi-Chat", buttonColor: "" },
          ...
          <>
            ...
            >
              ...
              <div className="flex-1 text-left min-w-0">
                ...
                <p className="text-xs text-muted-foreground">
                  {selectedUsers.length > 0 ? "Tap to add or remove users" : "Choose Mobiface users to send to"}
                </p>
              </div>
