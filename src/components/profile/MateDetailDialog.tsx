...
export const MateDetailDialog = ({ open, onOpenChange, mate, type }: MateDetailDialogProps) => {
  ...
  const renderSchoolMateDetails = (data: SchoolMate | Classmate) => (
    <>
      <div>
        <h4 className="font-semibold text-base text-muted-foreground mb-1">Full Name</h4>
        <p className="font-medium">{data.name}</p>
      </div>

      {data.nickname && (
        <div>
          <h4 className="font-semibold text-base text-muted-foreground mb-1">Nickname</h4>
          <p>{data.nickname}</p>
        </div>
      )}
      ...
      <div>
        <h4 className="font-semibold text-base text-muted-foreground mb-1">Institution</h4>
        <p>{data.institution}</p>
      </div>

      {data.period && (
        <div>
          <h4 className="font-semibold text-base text-muted-foreground mb-1">Period</h4>
          <p>{data.period}</p>
        </div>
      )}
      ...
      {data.postsHeld && (
        <>
          <Separator />
          <div>
            <h4 className="font-semibold text-base text-muted-foreground mb-1">Posts Held</h4>
      ...
      {data.sportsPlayed && (
        <div>
          <h4 className="font-semibold text-base text-muted-foreground mb-1">Sports Played</h4>
          <p className="whitespace-pre-wrap">{data.sportsPlayed}</p>
        </div>
      )}
      {data.clubsAssociations && (
        <div>
          <h4 className="font-semibold text-base text-muted-foreground mb-1">Clubs & Associations</h4>
      ...
      {(data.favouriteTeacher || data.teacherNickname || data.teacherHometown || data.teacherSubject || data.teacherPosition) && (
        <>
          <Separator />
          <div>
            <h4 className="font-semibold text-base text-primary mb-3">Favourite Class Teacher</h4>
            <div className="space-y-2 pl-4">
              ...
              {data.teacherNickname && (
                <div>
                  <span className="text-base text-muted-foreground">Nickname: </span>
                  <span>{data.teacherNickname}</span>
                </div>
              )}
              {data.teacherHometown && (
                <div>
                  <span className="text-base text-muted-foreground">Hometown: </span>
                  <span>{data.teacherHometown}</span>
                </div>
              )}
              {data.teacherSubject && (
                <div>
                  <span className="text-base text-muted-foreground">Subject: </span>
                  <span>{data.teacherSubject}</span>
                </div>
              )}
              {data.teacherPosition && (
                <div>
                  <span className="text-base text-muted-foreground">Position: </span>
      ...
      {data.privacy && (
        <>
          <Separator />
          <div>
            <h4 className="font-semibold text-base text-muted-foreground mb-1">Privacy</h4>
  ...
  const renderAgeMateDetails = (data: AgeMate) => (
    <>
      <div>
        <h4 className="font-semibold text-base text-muted-foreground mb-1">Name</h4>
        <p className="font-medium">{data.name}</p>
      </div>

      <div>
        <h4 className="font-semibold text-base text-muted-foreground mb-1">Community</h4>
        <p>{data.community}</p>
      </div>
      ...
      {data.ageGrade && (
        <div>
          <h4 className="font-semibold text-base text-muted-foreground mb-1">Age Grade</h4>
          <p>{data.ageGrade}</p>
        </div>
      )}
      ...
      {data.ageBrackets && (
        <div>
          <h4 className="font-semibold text-base text-muted-foreground mb-1">Age Brackets</h4>
  ...
  const renderColleagueDetails = (data: WorkColleague) => (
    <>
      ...
      <div>
        <h4 className="font-semibold text-base text-muted-foreground mb-1">Workplace</h4>
        <p>{data.workplaceName}</p>
      </div>

      {data.workplaceLocation && (
        <div>
          <h4 className="font-semibold text-base text-muted-foreground mb-1">Location</h4>
      ...
      {data.position && (
        <div>
          <h4 className="font-semibold text-base text-muted-foreground mb-1">Position</h4>
          <p>{data.position}</p>
        </div>
      )}
      ...
      {data.duration && (
        <div>
          <h4 className="font-semibold text-base text-muted-foreground mb-1">Duration</h4>
          <p>{data.duration}</p>
        </div>
      )}
      ...
      {data.superiority && (
        <>
          <Separator />
          <div>
            <h4 className="font-semibold text-base text-muted-foreground mb-1">Superiority</h4>
      ...
      {data.specialSkills && (
        <div>
          <h4 className="font-semibold text-base text-muted-foreground mb-1">Special Skills</h4>
