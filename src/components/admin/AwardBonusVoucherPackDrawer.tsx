            ...
            <CardContent className="p-3 flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-amber-700/80 mt-0.5 leading-relaxed">
                  ...
                  The value is credited directly to the Merchant's <strong>Mini‑Wallet</strong> and remains as such.
                </p>
              </div>
            </CardContent>
          </Card>
              ...
              <CardContent className="p-3 flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-blue-700/80 mt-0.5 leading-relaxed">
                    This bonus will be credited directly to <strong>{merchantName}'s Mini‑Wallet</strong>. 
              ...
              <CardContent className="p-3 flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-amber-700/80 mt-0.5">
                    Once awarded, the bonus voucher pack value will be immediately available in the merchant's Mini‑Wallet.
                  </p>
                </div>
              </CardContent>
            </Card>
      ...
      <div className="flex flex-col h-full">
        <div className="flex-1 flex flex-col items-center justify-center p-6 text-center">
          ...
          <p className="text-sm text-muted-foreground mb-6 max-w-[280px]">
            <strong>{getPackLabel(selectedPack)}</strong> has been successfully credited to <strong>{merchantName}'s Mini‑Wallet</strong>.
          </p>
