...
export function MobigateQuizManagement() {
  ...
  const allCategories = useMemo(() => {
    return [...new Set(levels.map((l) => l.category))].sort();
  }, [levels]);
  ...
  const handleToggleStatus = (id: string) => {
    ...
    toast({
      title: entry?.isActive ? "Level Deactivated" : "Level Activated",
      description: entry?.levelName,
    });
  };
        ...
        <AlertDialog open={!!deleteTarget} onOpenChange={(open) => !open && setDeleteTarget(null)}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                This will permanently remove this quiz level. This action cannot be undone.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
