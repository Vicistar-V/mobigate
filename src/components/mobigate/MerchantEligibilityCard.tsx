...
export function getEligibilityItems(): EligibilityItem[] {
  ...
  return [
    ...
    },
    {
      icon: Users,
      label: "Friends",
      description: `Must have at least ${e.requiredFriends.toLocaleString()} friends`,
      met: e.friends >= e.requiredFriends,
      current: e.friends.toLocaleString(),
      required: e.requiredFriends.toLocaleString(),
    },
    {
      icon: Users,
      label: "Followers",
      description: `Must have at least ${e.requiredFollowers.toLocaleString()} followers`,
      met: e.followers >= e.requiredFollowers,
      current: e.followers.toLocaleString(),
      required: e.requiredFollowers.toLocaleString(),
    },
    {
      icon: BookOpen,
