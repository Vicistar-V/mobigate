    ...
    <Card className="p-4 mb-4">
      <div className="space-y-4">
        ...
        <div className="overflow-x-auto -mx-4 px-4">
          ...
          <table className="min-w-[500px] border-collapse border-spacing-0">
            <thead>
              <tr>
                <th className="bg-pink-200 p-3 text-left min-w-[120px] sticky left-0 z-20 border border-gray-300">
                ...
                {office.candidates.map((candidate, index) => {
                  ...
                  return (
                    <th
                      key={candidate.id}
                      className={`${colors.header} p-3 text-center min-w-[120px] border border-gray-300`}
                    >
            ...
            <tbody>
              {/* Performance Row */}
              <tr>
                <td className="bg-pink-200 p-3 font-bold sticky left-0 z-20 border border-gray-300 min-w-[120px]">
                  <div className="text-sm leading-tight">
              ...
              {filteredRecords.map((record, recordIndex) => (
                <tr key={record.id}>
                  <td className="bg-pink-200 p-3 sticky left-0 z-20 border border-gray-300 min-w-[120px]">
