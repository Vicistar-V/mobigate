          ...
          <div className="flex-1 overflow-y-auto touch-auto px-4 py-4 space-y-4">
            ...
            <div className="bg-muted/30 rounded-xl p-4">
              <div className="flex items-start gap-3">
                {/* Avatar with supporters overlay - Clickable */}
                <div 
                  className="relative shrink-0 cursor-pointer touch-manipulation active:scale-[0.95]"
                ...
                <div 
                  className="flex-1 min-w-0 cursor-pointer touch-manipulation active:opacity-80"
                  onClick={() => navigate(`/profile/${campaign.candidateId}`)}
                >
                ...
                {/* Responses Badge - Clickable to open feedback list */}
                <Badge 
                  variant="outline" 
                  className="shrink-0 text-xs font-medium px-2.5 py-1 border-primary/30 bg-primary/5 cursor-pointer touch-manipulation active:scale-[0.95] hover:bg-primary/10 transition-colors"
