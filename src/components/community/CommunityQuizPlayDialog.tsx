...
import { X, Clock, Trophy, AlertTriangle, CheckCircle, XCircle, Wallet, Shield } from "lucide-react";
...
export function CommunityQuizPlayDialog({ open, onOpenChange, quiz, playerWalletBalance, onGameComplete }: CommunityQuizPlayDialogProps) {
  ...
  const startGame = () => {
    ...
    toast({ title: "Stake Deducted", description: `${quiz.currency} ${quiz.stakeAmount.toLocaleString()} deducted. Good luck!` });
