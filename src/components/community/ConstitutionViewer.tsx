      ...
      <DialogContent className="max-w-3xl max-h-[95vh] p-0 overflow-x-hidden">
        <DialogHeader className="p-3 pb-0 sticky top-0 bg-background z-20 border-b">
          ...
          <div className="flex gap-2 pb-2">
            ...
            <Button onClick={handleDownload} size="sm" variant="outline" className="shrink-0 h-9 px-2.5 touch-manipulation">
                  ...
                  {constitutionSections.map((section) => {
                    ...
                    return (
                      ...
                      >
                        <div className="mb-3">
                          {section.number && (
                            <Badge className="mb-1.5 text-[10px]">{section.number}</Badge>
                          )}
