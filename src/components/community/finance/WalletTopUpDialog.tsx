...
import { Wallet, CreditCard, Smartphone, Building2, CheckCircle2, ChevronRight, ChevronLeft, Globe, MapPin, ArrowRight } from "lucide-react";
  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-md max-h-[85vh] flex flex-col p-0 gap-0">
        ...
        {/* Step: Vouchers Selection */}
        {step === "vouchers" && (
          <div className="flex flex-col flex-1 min-h-0">
            <div className="flex-1 overflow-y-auto px-4 pb-2 touch-auto">
        ...
        {step === "merchants" && (
          <div className="flex flex-col flex-1 min-h-0">
            <div className="flex-1 overflow-y-auto px-4 pb-2 touch-auto space-y-4">
              ...
              <div className="space-y-2">
                <Label className="text-sm font-medium">Choose Merchant</Label>
                <p className="text-xs text-muted-foreground mb-3">
                  Select where you want to subscribe from
                </p>
