...
import { X, CreditCard, FileText, BookOpen, QrCode, Download, ExternalLink, Search } from "lucide-react";
            ...
            <TabsContent value="id-cards" className="mt-0 p-4 sm:p-6 space-y-4">
              <Card className="border-2">
                ...
                <CardContent className="space-y-4">
                  {/* ID Card Preview */}
                  <div className="bg-gradient-to-br from-primary/10 via-primary/5 to-background border-2 border-primary/20 rounded-xl p-6">
