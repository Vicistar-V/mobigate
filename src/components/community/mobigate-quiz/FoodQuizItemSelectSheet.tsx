...
export function FoodQuizItemSelectSheet({ open, onOpenChange }: FoodQuizItemSelectSheetProps) {
  ...
  const handleStart = () => {
    ...
    // In a full implementation, this would open FoodQuizPlayDialog
    toast({ title: "🎉 Mock Win!", description: `You won your grocery items worth ${formatLocalAmount(totalValue, "NGN")}!` });
    onOpenChange(false);
  };
