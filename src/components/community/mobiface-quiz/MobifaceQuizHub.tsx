...
import { mobifaceWalletData, mobifacePlayerStats } from "@/data/mobifaceQuizData";
...
export function MobifaceQuizHub({ open, onOpenChange, hideInteractive = false }: MobifaceQuizHubProps) {
                ...
                <CardContent className="p-3">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      <span className="font-bold text-amber-700 dark:text-amber-300">{formatLocalAmount(mobifaceWalletData.balance, "NGN")}</span>
                      <p className="text-xs text-amber-500">({formatMobiAmount(mobifaceWalletData.balance)})</p>
                    </div>
                  </div>
                ...
                <CardContent className="p-3">
                  ...
                  <div className="grid grid-cols-4 gap-2">
                    <div className="text-center p-2 bg-muted/50 rounded-lg">
                      <p className="font-bold text-base">{mobifacePlayerStats.gamesPlayed}</p>
                      <p className="text-xs text-muted-foreground">Played</p>
                    </div>
                    <div className="text-center p-2 bg-muted/50 rounded-lg">
                      <p className="font-bold text-base text-green-600">{mobifacePlayerStats.gamesWon}</p>
                      <p className="text-xs text-muted-foreground">Won</p>
                    </div>
                    <div className="text-center p-2 bg-muted/50 rounded-lg">
                      <p className="font-bold text-base text-amber-600">{mobifacePlayerStats.partialWins}</p>
                      <p className="text-xs text-muted-foreground">Partial</p>
                    </div>
                    <div className="text-center p-2 bg-muted/50 rounded-lg">
                      <p className="font-bold text-base text-red-500">{mobifacePlayerStats.gamesLost}</p>
