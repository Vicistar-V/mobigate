          ...
          {gameState === "pre_game" && (
            <div className="space-y-4">
              <Card className="bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-950/30 dark:to-orange-950/30 border-amber-200"><CardContent className="p-4 space-y-4">
                <div className="grid grid-cols-2 gap-3"><div className="text-center p-3 bg-white dark:bg-background rounded-lg border border-red-200"><p className="text-xs text-muted-foreground">Stake</p><p className="font-bold text-lg text-red-600">M{quiz.stakeAmount.toLocaleString()}</p></div><div className="text-center p-3 bg-white dark:bg-background rounded-lg border border-green-200"><p className="text-xs text-muted-foreground">Win Amount</p><p className="font-bold text-lg text-green-600">M{quiz.winningAmount.toLocaleString()}</p></div></div>
                {quiz.prizePool && <div className="p-3 bg-gradient-to-r from-amber-100 to-orange-100 rounded-lg text-center"><p className="text-xs text-amber-600">🏆 Prize Pool</p><p className="font-bold text-xl text-amber-700">M{quiz.prizePool.toLocaleString()}</p></div>}
              ...
              <Card className={cn("border-2", playerWalletBalance >= quiz.stakeAmount ? "border-green-300 bg-green-50" : "border-red-300 bg-red-50")}><CardContent className="p-4"><div className="flex items-center gap-3"><Wallet className={cn("h-5 w-5", playerWalletBalance >= quiz.stakeAmount ? "text-green-500" : "text-red-500")} /><div className="flex-1"><p className="text-sm font-medium">Your Wallet</p><p className="text-lg font-bold">M{playerWalletBalance.toLocaleString()}</p></div><Badge variant={playerWalletBalance >= quiz.stakeAmount ? "outline" : "destructive"} className={playerWalletBalance >= quiz.stakeAmount ? "bg-green-100 text-green-600" : ""}>{playerWalletBalance >= quiz.stakeAmount ? "Sufficient" : "Insufficient"}</Badge></div></CardContent></Card>
