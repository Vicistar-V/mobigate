...
export const ChatInterface = ({
  ...
  return <div className="flex-1 flex flex-col h-full bg-white">
      ...
      {!isSelectionMode && <div className="w-full border-b bg-[#f9f9f9] border-[#e9edef]">
          ...
          <div className="w-full py-3 flex items-center justify-start border-b border-[#e9edef] relative bg-[#f0e699] px-px">
          ...
          {/* User Info Row */}
          <div className="px-4 py-[10px] flex items-center bg-[#25d366]/20">
