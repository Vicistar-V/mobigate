...
export const mockNominations: Nomination[] = [
  ...
  },
  {
    id: "nom-7",
    nomineeId: "member-7",
    nomineeName: "Chief Obinna Okafor",
    nomineeAvatar: "/placeholder.svg",
    officeId: "office-1",
    officeName: "President General",
    nominatedBy: "member-7",
    nominatedByName: "Chief Obinna Okafor",
  ...
  },
  {
    id: "nom-8",
    nomineeId: "member-8",
    nomineeName: "Dr. Patricia Okafor",
    nomineeAvatar: "/placeholder.svg",
    officeId: "office-2",
    officeName: "Vice President",
    nominatedBy: "member-8",
    nominatedByName: "Dr. Patricia Okafor",
    nominatedAt: new Date("2025-01-18"),
    status: "approved",
    acceptedByNominee: true,
    acceptedAt: new Date("2025-01-18"),
    endorsementsCount: 41,
    qualificationStatus: "qualified",
    isSelfNomination: true,
  },
];
...
export const mockPrimaryElections: PrimaryElection[] = [
  {
    ...
    status: "completed",
  candidates: [
      { id: "cand-1", name: "Paulson Chinedu Okonkwo", avatar: "/placeholder.svg", votes: 245, percentage: 42.3, advancedToMain: true, autoQualified: true },
      { id: "cand-2", name: "Jerome Ifeanyi Adebayo", avatar: "/placeholder.svg", votes: 198, percentage: 34.2, advancedToMain: true, autoQualified: true },
      { id: "cand-3", name: "Emmanuel Kalu Nnamdi", avatar: "/placeholder.svg", votes: 89, percentage: 15.4, advancedToMain: false, autoQualified: false },
      { id: "cand-4", name: "Daniel Obiora Chibueze", avatar: "/placeholder.svg", votes: 47, percentage: 8.1, advancedToMain: false, autoQualified: false },
    ],
    totalVotesCast: 579,
  ...
  },
  {
    ...
    status: "completed",
  candidates: [
      { id: "vp-cand-1", name: "Grace Adaeze Okafor", avatar: "/placeholder.svg", votes: 312, percentage: 56.8, advancedToMain: true, autoQualified: true },
      { id: "vp-cand-2", name: "Emmanuel Chukwuemeka Ibe", avatar: "/placeholder.svg", votes: 237, percentage: 43.2, advancedToMain: true, autoQualified: true },
    ],
    totalVotesCast: 549,
    totalEligibleVoters: 850,
    winnerThreshold: 50,
