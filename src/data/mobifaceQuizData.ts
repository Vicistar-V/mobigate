...
export interface MobifaceQuizQuestion {
  id: string;
  question: string;
...
export interface MobifaceQuiz {
  ...
  startDate?: Date;
  endDate?: Date;
  questions?: MobifaceQuizQuestion[];
  prizePool?: number;
  badge?: string;
}

export interface MobifaceLeaderboardEntry {
  id: string;
  playerId: string;
  playerName: string;
  playerAvatar: string;
...
export interface MobifacePlayerStats {
  playerId: string;
  playerName: string;
  gamesPlayed: number;
  gamesWon: number;
...
export interface MobifaceWallet {
  balance: number;
...
export const MOBIFACE_ANSWER_LABELS = ["A", "B", "C", "D", "E", "F", "G", "H"] as const;

// Global quiz categories
export const mobifaceQuizCategories = [
  "World Trivia",
  "Pop Culture",
  "Science & Tech",
  "Sports Champions",
...
const globalKnowledgeQuestions: MobifaceQuizQuestion[] = [
  {
    id: "mq1",
...
const popCultureQuestions: MobifaceQuizQuestion[] = [
  {
    id: "pc1",
...
export const activeMobifaceQuizzes: MobifaceQuiz[] = [
  {
    id: "mobi-quiz-1",
...
export const mobifaceLeaderboard: MobifaceLeaderboardEntry[] = [
  {
    id: "ml1",
    playerId: "global-1",
...
export const mobifacePlayerStats: MobifacePlayerStats = {
...
// Mobiface Wallet
export const mobifaceWalletData: MobifaceWallet = {
  balance: 25000,
  totalEarnings: 67500,
  totalSpent: 42500,
...
// Mobiface Quiz Rules
export const mobifaceQuizRules = [
...
// Helper functions
export const isMobifaceQuizAvailable = (quiz: MobifaceQuiz): { available: boolean; reason?: string } => {
...
export const calculateMobifaceWinnings = (questionsCorrect: number, winningAmount: number): { percentage: number; amount: number; status: "won" | "partial_win" | "lost" } => {
