...
const ghanaMerchants: MobiMerchant[] = [
  { id: "gh-001", name: "Accra Mobi Hub", discountPercent: 4, city: "Accra", rating: 4.6, isVerified: true, isActive: true },
  { id: "gh-002", name: "CediExchange", discountPercent: 6, city: "Kumasi", rating: 4.4, isVerified: true, isActive: true },
  { id: "gh-003", name: "GhanaPay Solutions", discountPercent: 8, city: "Takoradi", rating: 4.5, isVerified: true, isActive: true },
];

// Kenya Merchants
const kenyaMerchants: MobiMerchant[] = [
  { id: "ke-001", name: "Nairobi Mobi Shop", discountPercent: 5, city: "Nairobi", rating: 4.7, isVerified: true, isActive: true },
  { id: "ke-002", name: "Safari Vouchers", discountPercent: 9, city: "Mombasa", rating: 4.5, isVerified: true, isActive: true },
  { id: "ke-003", name: "M-Pesa Mobi Link", discountPercent: 7, city: "Kisumu", rating: 4.6, isVerified: true, isActive: true },
];

// South Africa Merchants
const southAfricaMerchants: MobiMerchant[] = [
  { id: "za-001", name: "Joburg Mobi Center", discountPercent: 4, city: "Johannesburg", rating: 4.8, isVerified: true, isActive: true },
  { id: "za-002", name: "Cape Vouchers", discountPercent: 6, city: "Cape Town", rating: 4.6, isVerified: true, isActive: true },
  { id: "za-003", name: "Durban Digital Pay", discountPercent: 10, city: "Durban", rating: 4.4, isVerified: true, isActive: true },
];

// UK Merchants
const ukMerchants: MobiMerchant[] = [
  { id: "uk-001", name: "London Mobi Exchange", discountPercent: 3, city: "London", rating: 4.9, isVerified: true, isActive: true },
  { id: "uk-002", name: "Manchester Vouchers", discountPercent: 5, city: "Manchester", rating: 4.7, isVerified: true, isActive: true },
  { id: "uk-003", name: "Birmingham Pay Hub", discountPercent: 4, city: "Birmingham", rating: 4.5, isVerified: true, isActive: true },
];

// USA Merchants
const usaMerchants: MobiMerchant[] = [
  { id: "us-001", name: "NYC Mobi Store", discountPercent: 2, city: "New York", rating: 4.8, isVerified: true, isActive: true },
  { id: "us-002", name: "LA Digital Vouchers", discountPercent: 4, city: "Los Angeles", rating: 4.6, isVerified: true, isActive: true },
  { id: "us-003", name: "Houston Pay Center", discountPercent: 5, city: "Houston", rating: 4.5, isVerified: true, isActive: true },
  { id: "us-004", name: "Atlanta Mobi Hub", discountPercent: 6, city: "Atlanta", rating: 4.7, isVerified: true, isActive: true },
];

// Canada Merchants
const canadaMerchants: MobiMerchant[] = [
  { id: "ca-001", name: "Toronto Mobi Express", discountPercent: 3, city: "Toronto", rating: 4.7, isVerified: true, isActive: true },
  { id: "ca-002", name: "Vancouver Vouchers", discountPercent: 5, city: "Vancouver", rating: 4.6, isVerified: true, isActive: true },
];

// UAE Merchants
const uaeMerchants: MobiMerchant[] = [
  { id: "ae-001", name: "Dubai Mobi Gold", discountPercent: 8, city: "Dubai", rating: 4.9, isVerified: true, isActive: true },
  { id: "ae-002", name: "Abu Dhabi Pay Hub", discountPercent: 6, city: "Abu Dhabi", rating: 4.7, isVerified: true, isActive: true },
];
