...
const CommunityMembershipApplication = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    cityOfResidence: "",
    occupation: "",
    howHeard: inviteCode ? "invitation" : "",
    sponsorName: inviterName || "",
    motivation: "",
  });

  useEffect(() => {
    if (inviteCode && inviterName) {
      setFormData(prev => ({
        ...prev,
        howHeard: "invitation",
        sponsorName: inviterName
          ...
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-12 text-center">
              ...
              <p className="text-muted-foreground mb-6">
                Your membership application to <span className="font-medium text-foreground">{community.name}</span> is now pending review.
              </p>
              
              <div className="bg-muted/50 rounded-lg px-6 py-4 mb-6 w-full">
                <p className="text-sm text-muted-foreground mb-1">Reference Number</p>
                <p className="font-mono font-semibold text-xl">{referenceNumber}</p>
              </div>
              
              <p className="text-sm text-muted-foreground mb-8">
                Please save this reference number. You will receive a notification once your application is reviewed.
              </p>
      ...
      <main className="flex-1 container mx-auto px-4 py-6 max-w-lg">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-2 text-sm text-muted-foreground">
                  ...
                  <span>{community.followers?.toLocaleString() || "5,000+"} members</span>
                </div>
                {inviteCode && (
                  <Badge variant="secondary" className="mt-2 text-xs">
                    Invited by {inviterName || "a member"}
                  </Badge>
                )}
              </div>
            </div>
        ...
        <Card>
          <CardHeader className="bg-zinc-900 text-white rounded-t-lg">
            <CardTitle className="text-lg">Membership Application</CardTitle>
          </CardHeader>
          ...
          <CardContent className="p-4 space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div>
                <Label htmlFor="sponsor" className="text-sm">
                  Sponsor/Guarantor {inviteCode ? "" : "(Optional)"}
                </Label>
                <Input
                  id="sponsor"
                  ...
                  disabled={!!inviteCode && !!inviterName}
                />
              </div>
            </div>
            ...
            <p className="text-xs text-center text-muted-foreground">
              Your application will be reviewed by the community administrators.
...
export default CommunityMembershipApplication;