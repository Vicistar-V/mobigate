...
// MobifaceQuizManagement moved to /mobiface-admin/quiz
...
export default function MobifaceAdminDashboard() {
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <div className="overflow-x-auto -mx-4 px-4 mb-4">
            <TabsList className="inline-flex w-auto min-w-full h-auto whitespace-nowrap touch-pan-x">
              ...
              <TabsTrigger value="merchants" className="text-xs py-2 px-3" onClick={() => navigate("/mobiface-admin/merchants")}>
                <Store className="h-4 w-4 mr-1" />
                Merchants
              </TabsTrigger>
              <TabsTrigger value="communities" className="text-xs py-2 px-3" onClick={() => navigate("/mobiface-admin/communities")}>
                <Building2 className="h-4 w-4 mr-1" />
                Communities
              </TabsTrigger>
              <TabsTrigger value="users" className="text-xs py-2 px-3" onClick={() => navigate("/mobiface-admin/users")}>
              ...
              <div className="space-y-4 pb-6">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <Card
                    role="button"
                    tabIndex={0}
                    onClick={() => navigate("/mobiface-admin/communities")}
                    onKeyDown={(e) => { if (e.key === "Enter" || e.key === " ") { e.preventDefault(); navigate("/mobiface-admin/communities"); } }}
                  ...
                  <Card
                    role="button"
                    tabIndex={0}
                    onClick={() => navigate("/mobiface-admin/users")}
                    onKeyDown={(e) => { if (e.key === "Enter" || e.key === " ") { e.preventDefault(); navigate("/mobiface-admin/users"); } }}
                ...
                <Card>
                  ...
                  <CardContent className="grid grid-cols-2 gap-2">
                    ...
                    <Button variant="outline" size="sm" className="h-auto py-3 flex-col gap-1" onClick={() => navigate("/mobiface-admin/communities")}>
                      <Building2 className="h-5 w-5" />
                      <span className="text-xs">Communities</span>
                    </Button>
                    <Button variant="outline" size="sm" className="h-auto py-3 flex-col gap-1" onClick={() => navigate("/mobiface-admin/users")}>
          ...
          <TabsContent value="revenue" className="mt-0">
            <ScrollArea className="h-[calc(100vh-200px)]">
              <div className="space-y-4 pb-6 pr-1">
                <AdminAuthGate tabLabel="Revenue">
                  {/* Revenue Overview */}
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        ...
                        {[
                          ...
                          <Card key={item.route}
                            ...
                            onClick={() => navigate(`/mobiface-admin/quiz/${qt.type}/${item.route}`)}>
                            <CardContent className="p-2.5 flex items-center gap-2">
          ...
          <TabsContent value="adverts" className="mt-0">
            <ScrollArea className="h-[calc(100vh-200px)]">
              <div className="space-y-3 pb-6">
                {[
                  { label: "Set Ad Slot Rate", desc: "Configure pricing & discounts", icon: "💰", route: "/mobiface-admin/adverts/slot-rates" },
                  { label: "Manage All Adverts", desc: "View & manage advertisements", icon: "📋", route: "/mobiface-admin/adverts/manage" },
                  { label: "Promotional Ads", desc: "Upload & manage banners", icon: "📣", route: "/mobiface-admin/adverts/promotional" },
                ].map(item => (
                  <Card
                    key={item.route}
                    className="cursor-pointer hover:bg-accent/30 transition-colors active:scale-[0.98]"
